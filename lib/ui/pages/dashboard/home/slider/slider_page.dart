...
class DataSliderPage extends StatefulWidget {
  /// Initialize the instance of the [DataSliderPage] class.
  const DataSliderPage({Key? key}) : super(key: key);

  @override
  State<DataSliderPage> createState() => _DataSliderPageState();
}

class _DataSliderPageState extends State<DataSliderPage> {
  _DataSliderPageState();
